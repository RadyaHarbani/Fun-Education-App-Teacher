                ...
                Obx(() {
                  if (controller.searchQuery.value.isNotEmpty &&
                    ...
                    return Obx(() => ListView.builder(
                          shrinkWrap: true,
                          physics: NeverScrollableScrollPhysics(),
                          itemCount: controller.allGraduatedStudents.length,
                          itemBuilder: (context, index) {
                            return InkWell(
                                onTap: () {
                                  Get.toNamed(
                                    Routes.DETAIL_GRADUATED_STUDENT_PAGE,
                                    arguments: controller
                                        .allGraduatedStudents[index].id
                                        .toString(),
                                  );
                                },
                                child: GraduatedStudentItem(
                                  fullname: controller
                                      .allGraduatedStudents[index].fullName!,
                                  image: controller.allGraduatedStudents[index]
                                      .profilePicture!,
                                ));
                          },
                        ));
