...
class DetailTaskArchiveItem extends GetView<DetailTaskPageController> {
  const DetailTaskArchiveItem({
    Key? key,
    required this.type,
    required this.title,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Obx(() => CommonButton(
                  isLoading: controller.isLoadingUpdateStatusTask.value,
                  text: 'Kembalikan Tugas',
