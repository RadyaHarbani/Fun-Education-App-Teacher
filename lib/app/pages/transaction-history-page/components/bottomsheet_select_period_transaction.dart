...
class BottomsheetSelectPeriodTransaction extends GetView<TransactionHistoryPageController> {
  const BottomsheetSelectPeriodTransaction({super.key});
                ...
                () => Column(
                  children: [
                    CustomRadioButtonPeriod(
                      ...
                      onChanged: (value) => controller.selectedPeriod(value),
                    ),
                    CustomRadioButtonPeriod(
                      title: 'Bulanan',
                      value: 'Bulanan',
