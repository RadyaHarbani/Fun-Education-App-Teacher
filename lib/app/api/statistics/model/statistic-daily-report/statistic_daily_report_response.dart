...
StatisticDailyReportResponse statisticDailyReportResponseFromJson(String str) =>
    StatisticDailyReportResponse.fromJson(json.decode(str));

String statisticDailyReportResponseToJson(StatisticDailyReportResponse data) =>
...
class StatisticDailyReportResponse {
  ...
  factory StatisticDailyReportResponse.fromJson(Map<String, dynamic> json) =>
      StatisticDailyReportResponse(
        // totalData: json["total_data"],
        data: List<StatisticDailyReportModel>.from(
            json["data"].map((x) => StatisticDailyReportModel.fromJson(x))),
